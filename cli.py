...
class CLIHandler:
    ...
    def _init_list_tasks(self):
        parser_list_tasks = self._subparsers.add_parser("list-tasks", help="Print all tasks")
    ...
    def _init_list_groups(self):
        parser_list_groups = self._subparsers.add_parser("list-groups", help="Print all groups")
    ...
    def _init_delete_task(self):
        parser_delete_task = self._subparsers.add_parser("delete-task", help="Delete task")
    ...
    def _init_delete_group(self):
        parser_delete_group = self._subparsers.add_parser("delete-group", help="Delete Group")
    ...
    def _init_format_task(self):
        parser_format_task = self._subparsers.add_parser("format-task", help="Format task")
