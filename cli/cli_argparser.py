...
class CLIArgParser:
    ...
    def _init_add_task(self) -> None:
        parser_add_task = self._subparsers.add_parser(
            "add-task",
            help="Add task",
        )
    ...
    def _init_add_group(self) -> None:
        parser_add_group = self._subparsers.add_parser(
            "add-group",
            help="Add group",
        )
    ...
    def _init_list_tasks(self) -> None:
        parser_list_tasks = self._subparsers.add_parser(
            "list-tasks",
    ...
    def _init_list_groups(self) -> None:
        parser_list_groups = self._subparsers.add_parser(
            "list-groups",
    ...
    def _init_delete_task(self) -> None:
        parser_delete_task = self._subparsers.add_parser(
            "delete-task",
            help="Delete task",
        )
    ...
    def _init_delete_group(self) -> None:
        parser_delete_group = self._subparsers.add_parser(
            "delete-group",
            help="Delete Group",
        )
    ...
    def _init_format_task(self) -> None:
        parser_format_task = self._subparsers.add_parser(
            "format-task",
            help="Format task",
        )
        parser_format_task.add_argument(
            "id",
            type=int,
            nargs='+',
            help="Task`s ID",
    ...
    def _init_format_group(self) -> None:
        parser_format_group = self._subparsers.add_parser(
            "format-group",
            help="Format group",
        )
